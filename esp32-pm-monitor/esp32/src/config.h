...
#define SERVER_URL    "https://iitd-dsml-spotify.vercel.app"
...
// Both use the same UART frame; the only difference is that the PMS5003
// does not populate the >10 µm particle-count field (bytes 26-27 are reserved).
#define SENSOR_MODEL  5003

// ─── PMS5003 / PMS7003 UART pins (ESP32 Hardware Serial 2) ───────────────────
// PMS5003: connect pin 9 (TXD) → ESP32 RX, pin 7 (RXD) → ESP32 TX
// PMS7003: connect TX → ESP32 RX, RX → ESP32 TX
